/**
 * Hard constants — cannot be changed by community proposals yet (M5 experimental lock).
 * Temporary product choice while the loop is validated; more parameters are meant to
 * become voteable later (e.g. proposal quota, quorum size).
 */
 ...
 * Community proposals cannot change this yet (M5 experimental lock); maintainers change code only.
 * Intended to become community-legislated later alongside related voting parameters.
 */
